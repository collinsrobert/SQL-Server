...
/****** Object:  StoredProcedure [dbo].[usp_SQLServerRestartNotification]    Script Date: 9/10/2026 12:18:50 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	@profile_name = 'Database Mail Profile',---change to your database email profile
        @recipients = 'alert@domain.com',---change email alert
        @importance = 'high',
